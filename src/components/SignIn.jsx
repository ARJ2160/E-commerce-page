...
import { checksignIn, signInSuccess } from '../redux/signUpSlice';
    ...
    return (
        <section id="form" className='side-padding'>
            <div className="group d-flex justify-content-center align-items-center">
                <span style={{ fontSize: "2rem", padding: "1rem", color: "gold" }}>Sign In Form</span>
            </div>
            <div className="group form d-flex flex-column justify-content-center align-items-center">
                ...
                <p className="mt-5">Dont have an Account? <span><a href="/signup">Sign Up</a></span></p>
            </div>
        </section>
    )
}
